...
Vcity.allCity=['黄浦区,上海市,上海市|huangpuqu,shanghaishi,shanghaishi|hpq,shs,shs',
    ...
    '鼓楼区（南京市）,南京市,江苏省|gulouqu,nanjingshi,jiangsusheng|glq,njs,jss',
    ...
    '鼓楼区（徐州市）,徐州市,江苏省|gulouqu,xuzhoushi,jiangsusheng|glq,xzs,jss',
    ...
    '金坛市,常州市,江苏省|jintanshi,changzhoushi,jiangsusheng|jts,czs,jss',
    ...
    '吴江市,苏州市,江苏省|wujiangshi,suzhoushi,jiangsusheng|wjs,szs,jss',
    ...
    '大丰市,盐城市,江苏省|dafengshi,yanchengshi,jiangsusheng|dfs,ycs,jss',
    ...
    linkEvent:function(){
        ...
        for(var i=0,n=links.length;i<n;i++){
            links[i].onclick = function(){
                that.input.value = this.innerHTML.replace('<span class="hide">',',').replace('</span>','');
